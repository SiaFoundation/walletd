...
func testWalletReorg(storeFn func(t *testing.T, log *zap.Logger) wallet.Store) func(t *testing.T) {
...
func testWalletEphemeralBalance(storeFn func(t *testing.T, log *zap.Logger) wallet.Store) func(t *testing.T) {
	return func(t *testing.T) {
		log := zaptest.NewLogger(t)
		db := storeFn(t, log)
		bdb, err := coreutils.OpenBoltChainDB(filepath.Join(t.TempDir(), "consensus.db"))
...
func testWalletV2(storeFn func(t *testing.T, log *zap.Logger) wallet.Store) func(t *testing.T) {
	return func(t *testing.T) {
		log := zaptest.NewLogger(t)
		db := storeFn(t, log)
		bdb, err := coreutils.OpenBoltChainDB(filepath.Join(t.TempDir(), "consensus.db"))
...
func testWalletAddresses(storeFn func(t *testing.T, log *zap.Logger) wallet.Store) func(t *testing.T) {
	return func(t *testing.T) {
		log := zaptest.NewLogger(t)
		db := storeFn(t, log)
		...
		if err != nil {
			...
			t.Fatal("unexpected metadata", string(wallets[0].Metadata))
		}
